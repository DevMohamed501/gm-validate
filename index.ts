import checkErrors from "./lib/validateErrors.js";
import objectSchema from "./lib/object.js";
import { IObjectKeys, GmType } from "./types/types.js";
import typeOf from "./utils/typeOf.js";
export const useValidate = checkErrors;
...
const gm = function () {
    ...
    const validate = {
         ...
         */
        isEmail(_Message: String = "Email not valid", _support?: string[]): GmType {
